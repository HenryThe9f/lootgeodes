...
public class SmallGeodeEntity extends ThrowableItemProjectile {

  public static final ResourceLocation GEODE_LOOT = new ResourceLocation("loot_geodes","entities/overworld_geode");

    public SmallGeodeEntity(EntityType<? extends ThrowableItemProjectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    public SmallGeodeEntity(Level pLevel) {
        super(ModEntities.GEODE_BALL.get(), pLevel);
    }

    public SmallGeodeEntity(Level pLevel, LivingEntity livingEntity) {
        super(ModEntities.GEODE_BALL.get(), livingEntity, pLevel);
    }
    ...
    protected Item getDefaultItem() {
        return Moditems.SMALLGEODEHELD.get();
    }
    ...
    protected void onHitBlock(BlockHitResult pResult) {
        if (!this.level().isClientSide()) {
          ...
          //  this.spawnAtLocation(new ItemStack(Items.EMERALD));
            this.playSound(SoundEvents.AMETHYST_BLOCK_BREAK, 1.0F, 1.0F);
